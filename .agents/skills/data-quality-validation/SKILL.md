...
| Todo acceso a un expediente tiene base legal vigente | anti-join acceso ↔ consentimiento (`data-privacy-sensitive`) |
...
- Las salidas pueden contener PII: reportá IDs y conteos, no contenido (`data-privacy-sensitive`).
