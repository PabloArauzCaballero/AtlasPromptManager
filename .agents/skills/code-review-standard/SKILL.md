...
2. **Seguridad** — autorización a nivel de objeto y de función, validación en servidor, PII
...
- [ ] Seguridad: autz por objeto y función, validación servidor, PII fuera de logs/respuesta.
