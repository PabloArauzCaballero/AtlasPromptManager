...
- Datos sensibles o privados en una página indexable (consentimiento primero; ver `data-privacy-sensitive`).
...
- [ ] Nada privado/datos sensibles en páginas indexables.
