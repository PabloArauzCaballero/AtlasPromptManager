...
5. **Las búsquedas de personas no exponen datos sin base legal verificada** (regla 90.2.8).
...
`backend-development` · `nestjs-development` · `database-design` · `error-handling-contract` ·
