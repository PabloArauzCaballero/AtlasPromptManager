...
2. **Prohibido usar datos generados como si fueran un catálogo real.**
3. **Prohibido que datos personales, financieros o biométricos (PII) aparezcan** en logs, trazas, URLs,
...
`data-privacy-sensitive`, `seed-data-catalogs`.
