...
| `90-seguridad-y-datos-sensibles.md` | Controles obligatorios y datos personales, financieros y biométricos |
...
- `ATLAS_PLAN_GATE_OFF=1`, `ATLAS_REPORT_GATE_OFF=1` y `ATLAS_BLOCKER_GATE_OFF=1`
