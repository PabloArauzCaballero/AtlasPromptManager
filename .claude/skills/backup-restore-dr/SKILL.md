...
- **Cifrado** en tránsito y en reposo. Un backup contiene toda la PII del sistema sin los
  controles de acceso de la aplicación: es el activo más sensible que tenés (`data-privacy-sensitive`).
