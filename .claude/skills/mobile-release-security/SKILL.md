...
- Verificación de que analytics/crash no incluyen datos sensibles (muestra de un evento).
...
- [ ] Analytics y crash reporting sin datos sensibles ni tokens; declaraciones de la tienda veraces.
